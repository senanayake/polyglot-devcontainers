...
- `ghcr.io/<owner>/polyglot-devcontainers-solver-runner`
...
The research runner, solver runner, and LaTeX images are focused workflow
images for reproducible experiment execution, formal-tool receipts, and paper
builds.
